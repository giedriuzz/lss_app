...
def get_raport_description_from_raport_dictionary(dictionary: dict, dictionary_key: str, value_name: str):
    get_dictionary_key = dictionary[0][dictionary_key][value_name]
    if get_dictionary_key["description"] is None:
        print("")
    else:
...
if __name__ == "__main__":
    ...
    get_raport_description_from_raport_dictionary(dictionary=raport, dictionary_key="radio_raports", value_name=input_raport_name)
